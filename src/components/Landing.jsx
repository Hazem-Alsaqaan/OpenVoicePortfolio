...
const Landing = () => {
    return (
        <div id="#" className={`relative bg-[url('../../src/assets/pictures/Hero212.jpg')] bg-cover bg-no-repeat min-h-screen w-full after:absolute after:w-full after:h-full after:bg-blue-400 after:bg-opacity-50 after:top-0 after:left-0 flex items-center`}>
