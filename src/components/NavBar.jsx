...
const NavBar = ()=>{
    ...
    return(
        <div className={`flex-1  justify-end items-center pl-10 max-xsm:flex max-xsm:justify-end `}>
            ...
            <ul className={`${visibleNav?"max-xsm:visible":"max-xsm:hidden"} flex items-center justify-end gap-5  max-sm:gap-3 max-xsm:absolute max-xsm:top-full max-xsm:left-0 max-xsm:bg-blue-500 max-xsm:bg-opacity-85 max-xsm:w-full max-xsm:flex-col max-xsm:items-start max-xsm:p-4 `}>
                <li>
